...
// Fit Functions
inline Double_t kfit(const Double_t *x, const Double_t *par){  // Kaon Fit: Voight + 2nd degree polynomial
...
inline Double_t lfit(const Double_t *x, const Double_t *par){ // Lambda Fit: BreitWigner + Exponential + const
...
inline Double_t lifetime_fit_1exp(Double_t *x, Double_t *par){ 
